function ptbs_cse_002_def_msdi2(flag)
% QSMbox
%  Default MSDI v2 pipeline for coil-combined single-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI v2 pipeline for combined single-echo data')
ptb.pipename = {'cse_002_def_msdi2'}; 
