function ptbs_use_002_def_msdi2(flag)
% QSMbox
%  Default MSDI v2 pipeline for coil-uncombined single-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI v2 pipeline for uncombined single-echo data')
ptb.pipename = {'use_002_def_msdi2'}; 
