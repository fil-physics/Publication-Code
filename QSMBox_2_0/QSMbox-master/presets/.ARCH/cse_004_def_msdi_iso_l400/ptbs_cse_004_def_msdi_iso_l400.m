function ptbs_cse_004_def_msdi_iso_l400(flag)
% QSMbox
%  Default MSDI pipeline (with isotropic reslicing) for coil-combined single-GRE data
%
% USAGE 
...
ptb.pipename = {'cse_004_def_msdi_iso_l400'}; 
