function ptbs_use_002_def_msdi_js_l750(flag)
% QSMbox
%  Thalamus-optimised settings for 7T coil-uncombined single-GRE data
%
% USAGE 
...
%    - ptb_TE.txt                      echo time(s) in s,       e.g. 0.02 (i.e. 20 ms)
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Thalamus-optimised MSDI settings for 7T data, 3 scales, L=750')
ptb.pipename = {'use_002_def_msdi_js_l750'};
