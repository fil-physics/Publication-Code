function ptbs_use_003_def_msdi_ek_l750(flag)
% QSMbox
%  Cortex-optimised MSDI settings for 7T coil-uncombined single-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Cortex-optimised MSDI settings for 7T data, 2 scales, L=750')
ptb.pipename = {'use_003_def_msdi_ek_l750'}; 
