function ptbs_use_001_def_msdi_l400(flag)
% QSMbox
%  Default MSDI pipeline for coil-uncombined single-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI pipeline, L=400')
ptb.pipename = {'use_001_def_msdi_l400'}; 
