function ptbs_cse_002_def_nmedi_smv6_l400(flag)
% QSMbox
%  Default nMEDI pipeline (with 6-mm SMV deconvolution) for coil-combined single-GRE data
% 
% USAGE 
...
%  7. qsm.MSDI  -------------------------  On current settings, non-linear MEDI with SMV deconvolution
% 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default pipeline for nMEDI with 6-mm SMV sharpening, L=400')
ptb.pipename = {'cse_002_def_nmedi_smv6_l400'}; 
...
ptb.qsm.MSDI.smv           = true; % <- No deconvolution, standard nMEDI
ptb.qsm.MSDI.R_smv         = [6];        
