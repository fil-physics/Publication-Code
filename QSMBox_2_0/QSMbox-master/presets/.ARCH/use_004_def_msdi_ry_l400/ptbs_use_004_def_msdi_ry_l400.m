function ptbs_use_004_def_msdi_ry_l400(flag)
% QSMbox
%  Default pipeline for coil-uncombined single-GRE data with isotropic
%  reslicing
%
% USAGE 
...
%     - prep.zeropad  -------------------   Upsample data to isotropic resolution via zero-padding (3rd dim only)
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI pipeline with isotropic reslicing, L=400')
ptb.pipename = {'use_004_def_msdi_ry_l400'}; 
