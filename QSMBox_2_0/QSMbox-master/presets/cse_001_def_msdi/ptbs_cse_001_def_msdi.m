function ptbs_cse_001_def_msdi(flag)
% QSMbox
%  Default MSDI v1 pipeline for coil-combined single-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI v1 pipeline for combined single-echo data')
ptb.pipename = {'cse_001_def_msdi'}; 
