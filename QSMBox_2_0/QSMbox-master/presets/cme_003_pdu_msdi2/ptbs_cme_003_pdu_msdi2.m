function ptbs_cme_003_pdu_msdi2(flag)
% QSMbox
%  Alternative MSDI v2 settings for coil-combined multi-GRE data
%
% NOTES
%  + This pipeline removes background fields for each echo separately prior
%    to complex temporal fitting.
% 
%  + This is not the recommended setting for this data type, but it appears
%    to be robust to global (echo-specific) coil-combination errors.
% 
%  + This pipeline was optimised in the context of a research collaboration 
%    with Petr Dusek (Prague).
% 
% USAGE 
...
%  2. comb.dlapl_lbv_vsmv  --------------  Echo-wise pre-processing (no combination, keep magn/phase 4D structure). Filters: discrete Laplacian + Laplacian boundary value (MEDI toolbox) + variable spherical mean value (Bilgic/Bouwman implementation)
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Alternative MSDI v2 pipeline for combined multi-echo data')
ptb.pipename = {'cme_003_pdu_msdi2'}; 
...
%% MULTI-ECHO SPECIFIC OPTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Keep 4D magn/phase structure after prefiltering
ptb.comb.keep_uncombined = true;             
