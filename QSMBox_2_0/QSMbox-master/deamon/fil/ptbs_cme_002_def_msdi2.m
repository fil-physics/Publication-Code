function ptbs_cme_002_def_msdi2(flag)
% QSMbox
%  Default MSDI v2 pipeline for coil-combined multi-GRE data
%
% USAGE 
...
%% DEFINE PIPELINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('Default MSDI v2 pipeline for combined multi-echo data')
ptb.pipename = {'cme_002_def_msdi2'};
