function y = m1_tl_medin_sphere_kernel(matrix_size,voxel_size,radius)
% Generate a Spherical kernel with its sum normalized to one
%   y = m1_tl_medin_sphere_kernel(matrix_size,voxel_size,radius)
%   
%   OUTPUT
%   y - kernel
% 
